...
public class Grub extends ApplicationController {
    ...
    private Entity createRestaurantDemoModel(){
        RestaurantModel restaurant = new RestaurantModel("Elite SuperMarket", "https://sergeycodenameone.github.io/restaurant.png", "Italian", 4.7, 5, "https://sergeycodenameone.github.io/restaurant-icon.png",30, createDemoMenu());
        return restaurant;
    }
